if([Security.Principal.WindowsPrincipal]::New([Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator))
{
    ...
    $html_start = "<!DOCTYPE html>`n<html>`n    <head>`n        <meta name=`"viewport`" content=`"width=device-width,initial-scale=1`">`n        <title>IP Addresses</title>`n                <style type=`"text/css`">`n            body, html {`n                width: 100%;`n                height: 100%;`n                font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;`n            }`n            .main {`n                width: 90%;`n                margin: auto;`n            }`n            table {`n                width: 90%;`n                margin: auto;`n            }`n            .buttondiv {`n                width: 90%;`n                margin: auto;`n            }`n            .name {`n                border-top: 1px solid black;`n                border-right: 1px solid black;`n                border-left: 1px solid black;`n                font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;`n                font-weight: bold;`n            }`n            .value {`n                border-top: 1px solid black;`n                border-right: 1px solid black;`n                font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;`n            }`n            .valueleft {`n                border-top: 1px solid black;`n                border-left: 1px solid black;`n                border-right: 1px solid black;`n                font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;`n            }`n            .ntop {`n                border-top-left-radius: 0.5em;`n            }`n            .vtop {`n                border-top-right-radius: 0.5em;`n            }`n            .nbottom {`n                border-bottom-left-radius: 0.5em;`n                border-bottom: 1px solid black;`n            }`n            .vbottom {`n                border-bottom-right-radius: 0.5em;`n                border-bottom: 1px solid black;`n            }`n            td,th {`n                padding: 5px;`n                white-space: nowrap;`n            }`n            .midbottom {`n                border-bottom: 1px solid black;`n            }`n        </style>`n        <script type=`"application/javascript`">`n            function showAll(){`n                var rows = [];`n                [...document.getElementById(`"iptable`").getElementsByTagName(`"tr`")].filter((i)=>{`n                    return (!i.children[1].innerText.match(/IP is unassigned/));`n                }).forEach(i=>{`n                    rows.push(i);`n                });`n                rows[rows.length - 1].children[0].classList.remove(`"nbottom`");`n                rows[rows.length - 1].children[1].classList.remove(`"midbottom`");`n                rows[rows.length - 1].children[2].classList.remove(`"vbottom`");`n                [...document.getElementById(`"iptable`").getElementsByTagName(`"tr`")].filter((i)=>{`n                    return (i.children[1].innerText.match(/IP is unassigned/));`n                }).forEach((i)=>{`n                    i.style.display = `"table-row`";`n                });`n                document.getElementById(`"toggle`").innerText = `"Hide Unassigned`";`n                document.getElementById(`"toggle`").removeEventListener(`"click`",showAll);`n                document.getElementById(`"toggle`").addEventListener(`"click`",hideUnassigned);`n            }`n            function hideUnassigned(){`n                var rows = [];`n                [...document.getElementById(`"iptable`").getElementsByTagName(`"tr`")].filter((i)=>{`n                    return (!i.children[1].innerText.match(/IP is unassigned/));`n                }).forEach(i=>{`n                    rows.push(i);`n                });`n                rows[rows.length - 1].children[0].classList.add(`"nbottom`");`n                rows[rows.length - 1].children[1].classList.add(`"midbottom`");`n                rows[rows.length - 1].children[2].classList.add(`"vbottom`");`n                [...document.getElementById(`"iptable`").getElementsByTagName(`"tr`")].filter((i)=>{`n                    return (i.children[1].innerText.match(/IP is unassigned/));`n                }).forEach((i)=>{`n                    i.style.display = `"none`";`n                });`n                document.getElementById(`"toggle`").innerText = `"Show All`";`n                document.getElementById(`"toggle`").removeEventListener(`"click`",hideUnassigned);`n                document.getElementById(`"toggle`").addEventListener(`"click`",showAll);`n            }`n            document.addEventListener(`"DOMContentLoaded`",()=>{`n                document.getElementById(`"toggle`").addEventListener(`"click`",hideUnassigned);`n            })`n        </script>`n    </head>`n    <body>`n        <div class=`"main`">`n            <table>`n                <tr>`n                    <td class=`"name ntop`">localhost</td>`n                    <td class=`"value vtop`">$($ipv4)</td>`n                </tr>`n                <tr>`n                    <td class=`"name`">default gateway</td>`n                    <td class=`"value`">$($gateway)</td>`n                </tr>`n                <tr>`n                    <td class=`"name`">subnet prefix length</td>`n                    <td class=`"value`">$($cidr)</td>`n                </tr>`n                <tr>`n                    <td class=`"name`">number of assignable ip addresses</td>`n                    <td class=`"value`">$($possible_hosts)</td>`n                </tr>`n                <tr>`n                    <td class=`"name`">first IP address</td>`n                    <td class=`"value`">$($ip_range_start)</td>`n                </tr>`n                <tr>`n                    <td class=`"name nbottom`">last IP address</td>`n                    <td class=`"value vbottom`">$($ip_range_end)</td>`n                </tr>`n            </table>`n            <div class=`"buttondiv`">`n                <button id=`"toggle`">Hide Unassigned</button>`n            </div>`n            <table id=`"iptable`">`n                <tr>`n                    <th class=`"valueleft ntop`">IP address</th>`n                    <th class=`"value`">Hostname</th>`n                    <th class=`"value vtop`">MAC address</th>`n                </tr>`n"
